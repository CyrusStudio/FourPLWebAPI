...
public class DataExchangeService : IDataExchangeService
{
    ...
    private readonly ISftpConnectionFactory _sftpFactory;
    private readonly IEmailHelper _emailHelper;

    // 設定區段
    private readonly IConfigurationSection _localToSapSection;
    private readonly IConfigurationSection _zlSection;
    private readonly IConfigurationSection _arichSection;
    ...
    public DataExchangeService(
        ...
        ISftpConnectionFactory sftpFactory,
        IEmailHelper emailHelper)
    {
        ...
        // 載入設定區段
        _localToSapSection = configuration.GetSection("DataExchange:LocalToSap");
        _zlSection = configuration.GetSection("DataExchange:SftpTargets:ZL");
        _arichSection = configuration.GetSection("DataExchange:SftpTargets:ARICH");
    }
