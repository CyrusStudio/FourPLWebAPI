...
/// </summary>
public class MockSapHelper : ISapHelper
{
    private readonly ILogger<MockSapHelper> _logger;

    /// <summary>
    /// 建構函式
    /// </summary>
    /// <param name="logger">日誌記錄器</param>
    public MockSapHelper(ILogger<MockSapHelper> logger)
    {
        _logger = logger;
    }
    ...
    /// 生成模擬的機櫃資料
    /// </summary>
    private List<Dictionary<string, object>> GenerateMockCabinetData()
    {
    ...
    /// 生成模擬的物料清單
    /// </summary>
    private List<Dictionary<string, object>> GenerateMockMaterialList()
    {
        return new List<Dictionary<string, object>>
        {
