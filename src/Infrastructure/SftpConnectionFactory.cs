...
/// </summary>
public class SftpConnectionFactory : ISftpConnectionFactory
{
    private readonly IConfiguration _configuration;
    private readonly ILogger<SftpConnectionFactory> _logger;

    /// <summary>
    /// 建構函式
    /// </summary>
    public SftpConnectionFactory(IConfiguration configuration, ILogger<SftpConnectionFactory> logger)
    {
