...
namespace FourPLWebAPI.Infrastructure.Persistence;

/// <summary>
/// SQL Helper 實作
/// 封裝 Dapper，自動處理 Connection 生命週期
/// </summary>
public class SqlHelper(IConfiguration configuration, ILogger<SqlHelper> logger) : ISqlHelper
{
    private readonly string _connectionString = configuration.GetConnectionString("SAPDSConnection")
            ?? throw new InvalidOperationException("未設定 SAPDSConnection 連線字串");
    private readonly IConfiguration _configuration = configuration;
    private readonly ILogger<SqlHelper> _logger = logger;
